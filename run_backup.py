import os
from page.realestate import fetch_kb_weekly_price_index, fetch_kb_weekly_rent_index, fetch_kb_monthly_price_index, fetch_kb_transaction_volume_simple
import requests
"""
...
for code, name in REGION_CODES.items():
    ...
    거래량 = fetch_kb_transaction_volume_simple(code)
